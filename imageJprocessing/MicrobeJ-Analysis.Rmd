---
title: "20200923-Infection_Microscopy"
author: "Ramirez_Luis"
date: "23/09/2020"
...
Build grid of p-values from pairwise comparison:
1. Function to perform Tukey HSD test:
```{r}
...
```
2. Apply function and make a stack of p-values translated in color intensity
```{r message=FALSE, warning=FALSE}
RefPhage <- c("WT")
